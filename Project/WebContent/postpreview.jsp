...
<head>
	...
	<title>Posting Preview</title>
	
	<meta name="description" content="A Craigslist-like Site">
				...
				<div class="row">
					...
					<div class="main col-md-12">
						...
						<div class="alert alert-icon alert-info" role="alert">
							<form role="form" method="POST" action = "previewController">
								...
								&nbsp;
								<button class="btn btn-default" type="submit" name="action" value="publish">publish</button>
							</form>
						</div>
